...
{
	/// <summary>
	/// Override metadata for BoxDimensionsOverride
	/// </summary>
	public partial class BoxDimensionsOverride : IOverride
	{
        public static string Name = "Box Dimensions";
        public static string Dependency = null;
        public static string Context = "[*discriminator=Elements.BoxElement]";
	...
	public static class BoxDimensionsOverrideExtensions
    {
		/// <summary>
        /// Apply Box Dimensions edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Box Dimensions Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<BoxDimensionsOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, BoxDimensionsIdentity, bool> identityMatch,
            Func<T, BoxDimensionsOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Box Dimensions Overrides to apply — typically `input.Overrides.BoxDimensions`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<BoxDimensionsOverride> overrideData,
            Func<T, BoxDimensionsIdentity, bool> identityMatch,
            Func<T, BoxDimensionsOverride, T> modifyElement
            ) where T : Element
        {
