...
{
	/// <summary>
	/// Override metadata for ArrayEditOverride
	/// </summary>
	public partial class ArrayEditOverride : IOverride
	{
        public static string Name = "Array Edit";
        public static string Dependency = null;
        public static string Context = "[*discriminator=Elements.Stack]";
	...
	public static class ArrayEditOverrideExtensions
    {
		/// <summary>
        /// Apply Array Edit edit overrides to a collection of existing elements
        /// </summary>
        /// <param name="overrideData">The Array Edit Overrides to apply</param>
        ...
        public static List<T> Apply<T>(
            this IList<ArrayEditOverride> overrideData,
            IEnumerable<T> existingElements,
            Func<T, ArrayEditIdentity, bool> identityMatch,
            Func<T, ArrayEditOverride, T> modifyElement) where T : Element
        {
        ...
        /// </summary>
        /// <param name="existingElements">A collection of existing elements to which to apply the overrides.</param>
        /// <param name="overrideData">The Array Edit Overrides to apply — typically `input.Overrides.ArrayEdit`</param>
        /// <param name="identityMatch">A function returning a boolean which indicates whether an element is a match for an override's identity.</param>
        /// <param name="modifyElement">A function to modify a matched element, returning the modified element.</param>
        /// <typeparam name="T">The element type this override applies to. Should match the type(s) in the override's context.</typeparam>
        /// <returns>A collection of elements, including unmodified and modified elements from the supplied collection.</returns>
        public static void ApplyOverrides<T>(
            ...
            IList<ArrayEditOverride> overrideData,
            Func<T, ArrayEditIdentity, bool> identityMatch,
            Func<T, ArrayEditOverride, T> modifyElement
            ) where T : Element
        {
