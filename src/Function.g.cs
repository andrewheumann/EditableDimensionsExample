...
namespace EditableDimensionsExample
{
    public class Function
    {
        ...
        private IModelStore<EditableDimensionsExampleInputs> store;

        public async Task<EditableDimensionsExampleOutputs> Handler(EditableDimensionsExampleInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<EditableDimensionsExampleInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<EditableDimensionsExampleInputs,EditableDimensionsExampleOutputs>(store, EditableDimensionsExample.Execute);
